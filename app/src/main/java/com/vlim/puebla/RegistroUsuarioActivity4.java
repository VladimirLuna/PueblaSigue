...
public class RegistroUsuarioActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_cel = (TextView) findViewById(R.id.tv_cel);
        ...
        et_nombredependiente = (EditText) findViewById(R.id.et_nombrecontacto);
        et_nombredependiente.setTypeface(tf);
        et_teldependiente = (EditText) findViewById(R.id.et_telcontacto);
        ...
        et_usrdependiente = (EditText) findViewById(R.id.et_celcontacto);
